...
fitness=@(x) objfuneven(x,W,R,alpha,power,datasize,bandwidth,a,b,c,rtt);
x=ga(fitness,7,A,B,Aeq,Beq,lb,ub,@(x)constraintseven(x,R,W),intcon);
...
filename = ['rawresult/even/even-raw-' num2str(W) '-' num2str(R) '-' num2str(alpha)];
